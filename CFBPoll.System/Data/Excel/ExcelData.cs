...
namespace CFBPoll.System.Data.Modules
{
    public class ExcelData
    {
        ...
        public ExcelData(NameCorrector nameCorrector)
        {
            _nameCorrector = nameCorrector;
        }

        public ExcelData(IConfiguration config, NameCorrector nameCorrector)
        {
            _nameCorrector = nameCorrector;
        ...
        public IDictionary<string, Statistics> GetStatistics(string type, int season, int? week)
        {
            ...
            return GetStatistics(filePath);
        }

        /// <summary>
        /// Gets a dictionary of team statistics from the given Excel file.
        /// </summary>
        /// <param name="filePath">The path to the Excel file.</param>
        /// <returns>A dictionary of team statistics.</returns>
        public IDictionary<string, Statistics> GetStatistics(string filePath)
        {
            var statsTable = GetTableFromExcelFile(filePath, "Sheet2");
        ...
        /// <param name="worksheetName">The name of the worksheet to get from the Excel file.</param>
        /// <returns>An IXLTable from the given file path.</returns>
        private IXLTable GetTableFromExcelFile(string filePath, string worksheetName)
        {
